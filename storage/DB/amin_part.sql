...
CREATE TABLE IF NOT EXISTS ADDRESS(
    ...
    PRIMARY KEY(ID,Province,Remainer), --ON DELETE CASCADE,
    FOREIGN KEY(ID) REFERENCES CLIENT(ID) --ON DELETE CASCADE,
);
...
CREATE TABLE IF NOT EXISTS LOCKED_SHOPPING_CART(
    ...
    FOREIGN KEY(Cart_number) REFERENCES SHOPPING_CART(Number) 
);
...
CREATE TABLE IF NOT EXISTS APPLIED_TO(
    ...
    FOREIGN KEY(Code) REFERENCES DISCOUNT_CODE(Code),
    FOREIGN KEY(Locked_number) REFERENCES LOCKED_SHOPPING_CART(Number),
    FOREIGN KEY(Cart_number) REFERENCES LOCKED_SHOPPING_CART(Cart_number)
    );
